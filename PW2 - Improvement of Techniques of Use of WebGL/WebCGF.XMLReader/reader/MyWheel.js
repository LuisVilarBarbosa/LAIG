...
MyWheel.prototype.define_materials = function () {
    this.tire_rubber_material = new CGFappearance(this.scene);
    this.tire_rubber_material.setAmbient(0.8, 0.8, 0.8, 1);
    this.tire_rubber_material.setDiffuse(0.2, 0.2, 0.2, 1.0);
    this.tire_rubber_material.setSpecular(0, 0, 0, 1.0);
    this.tire_rubber_material.setShininess(1);
    this.tire_rubber_material.loadTexture('./images/tire_rubber.jpg');
    this.tire_rubber_material.setTextureWrap('CLAMP_TO_EDGE', 'CLAMP_TO_EDGE');
...
MyWheel.prototype.display = function () {
    ...
    this.tire_rubber_material.apply();
    this.scene.pushMatrix();
